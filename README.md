...
| **Primary Ranking Metric** | $\text{ACC}_{\text{EN}}$ | **The official ranking metric.** This metric rewards high accuracy and smoothly penalizes content bias, favoring models that are both correct and robust. |
