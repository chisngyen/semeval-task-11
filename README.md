...
| **Primary Ranking Metric** | $$\frac{\text{Avg}_{\text{Multi}}}{1 + \ln(1 + \text{TCE}_{\text{Multi}})}$$ | **The official ranking metric.** This metric rewards high accuracy and smoothly penalizes content bias, favoring models that are both correct and robust. |
