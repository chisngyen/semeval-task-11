"""
================================================================================
SemEval-2026 Task 11 - Subtask 1: Experiment 20 - Exp17 + Exp9 Combined
================================================================================
Description: Combine the two most successful approaches:
             - Exp17: Counterfactual Augmentation (Best TCE = 3.13)
             - Exp9: R-Drop + Label Smoothing (Best Previous Combined Score = 35.19)
             
Goal: Leverage Exp17's debiasing with Exp9's regularization for maximum score.
      Target: Combined Score > 40
...
# ============================================================================
# 3. CONFIGURATION (Exp9 settings + CF)
# ============================================================================
class Config:
    ...
    OUTPUT_DIR = '/kaggle/working/deberta_exp20'
    ...
    # Exp9 Hyperparameters
    BATCH_SIZE = 8  # Smaller for R-Drop (runs twice) + CF
    LEARNING_RATE = 5e-6
    WEIGHT_DECAY = 0.01
    NUM_EPOCHS = 10
    WARMUP_RATIO = 0.15
    LABEL_SMOOTHING = 0.1
    RDROP_ALPHA = 0.7  # R-Drop weight
    
    # Exp17 Counterfactual Augmentation
    CF_RATIO = 0.3
...
# ============================================================================
# 4. COUNTERFACTUAL GENERATOR (From Exp17)
# ============================================================================
class CounterfactualGenerator:
    def __init__(self, all_data):
        ...
        print(f"   CF pool: {len(self.valid_conclusions)} valid, {len(self.invalid_conclusions)} invalid")
...
def create_logic_prompt(syllogism_text):
    """Simple logic-aware prompt (works well with Exp17)"""
...
# ============================================================================
# 7. TRAINING WITH R-DROP (From Exp9)
# ============================================================================
...
def main():
    print("=" * 70)
    print("Exp 20: Exp17 (Counterfactual) + Exp9 (R-Drop)")
    print("  - Counterfactual Augmentation (Best TCE)")
    print("  - R-Drop + Label Smoothing (Best Robustness)")
    print("=" * 70)
    ...
    # Enable CF augmentation for training
    train_dataset = AugmentedDataset(train_split, tokenizer, Config.MAX_LENGTH, 
                                     cf_generator=cf_generator, cf_ratio=Config.CF_RATIO)
    val_dataset = AugmentedDataset(val_split, tokenizer, Config.MAX_LENGTH)
