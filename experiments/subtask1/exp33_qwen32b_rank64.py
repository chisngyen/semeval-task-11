"""
================================================================================
SemEval-2026 Task 11 - Subtask 1: Experiment 33 - Qwen 32B High Rank
================================================================================
Description: Scaling up from 14B to 32B, keeping the successful Exp28b config.
             
             User Request: "Make one like Exp28b (High Rank) but for 32B".
             
             Configuration:
             - Model: Qwen/Qwen2.5-32B-Instruct ("The Big Brother")
             - Method: QLoRA (4-bit)
             - Rank: 64 (High Capacity)
             - Alpha: 128
             - Augmentation: Exp21 Fixed CF (SOTA Data)
             
             Hardware Note:
             - 32B Int4 requires ~20GB VRAM for weights.
             - Activation + Optimizer will take more.
             - H100 (80GB) can handle this easily.
             - Enabled Gradient Checkpointing just in case.
...
class Config:
    ...
    OUTPUT_DIR = '/kaggle/working/qwen32b_exp33_rank64'
    ...
    # QLoRA params (HIGH RANK from Exp28b)
    LORA_R = 32
    LORA_ALPHA = 64
    LORA_DROPOUT = 0.05
    
    # Training params
    # 32B is heavy. We keep Batch Size small but Accumulation high.
    BATCH_SIZE = 2      
    GRAD_ACCUMULATION = 16 # Increased accumulation for stable 32B training
    LEARNING_RATE = 2e-4
    WEIGHT_DECAY = 0.01
    NUM_EPOCHS = 3
    WARMUP_RATIO = 0.03
...
# ============================================================================
# 4. COUNTERFACTUAL GENERATOR (Same as Exp28b)
# ============================================================================
...
# ============================================================================
# 5. LOGIC-AWARE PROMPT (Standard Logic Prompt)
# ============================================================================
...
def main():
    print("=" * 70)
    print(f"Exp 33: {Config.MODEL_NAME} (32B) - RANK 64")
    print("=" * 70)
    ...
    # Enable Gradient Checkpointing for 32B
