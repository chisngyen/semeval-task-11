"""
================================================================================
SemEval-2026 Task 11 - Subtask 1: Experiment 26 - Qwen 2.5 14B (LoRA)
================================================================================
Description: Fine-tuning Qwen 2.5 14B Instruct.
             
             REPLACEMENT FOR LLAMA 3 8B:
             1. Qwen 2.5 14B is significantly stronger than Llama 3 8B.
             2. It fits on an H100 with 4-bit quantization.
             3. It is generally ungated (fixes the HF Token error).
             
Model: Qwen/Qwen2.5-14B-Instruct
Method: QLoRA (4-bit, rank 16)
Prompt: Logic-Aware Prompt
             
Difficulty: Very Hard
Hardware: Kaggle H100 GPU (Utilization ~20-22GB VRAM)
================================================================================
"""
...
class Config:
    ...
    # Training params
    # 14B requires smaller batch size or more accumulation
    BATCH_SIZE = 2      
    GRAD_ACCUMULATION = 8
    LEARNING_RATE = 2e-4
    WEIGHT_DECAY = 0.01
...
def main():
    print("=" * 70)
    print(f"Exp 26: {Config.MODEL_NAME} (QLoRA) - UPGRADED")
    print("=" * 70)
