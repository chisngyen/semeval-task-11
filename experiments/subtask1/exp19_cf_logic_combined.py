"""
================================================================================
SemEval-2026 Task 11 - Subtask 1: Experiment 19 - Exp17 + Exp12 Combined
================================================================================
Description: Combine the best of both worlds:
             - From Exp17: Counterfactual Augmentation (best TCE = 3.13)
             - From Exp12: Logic-Aware Prompt (best ACC = 96.34%)
             
Goal: ACC > 95% AND TCE < 3.5 → Combined Score > 40
...
class Config:
    ...
    OUTPUT_DIR = '/kaggle/working/deberta_exp19'
    ...
    BATCH_SIZE = 10  # Smaller due to longer sequences + augmentation
    LEARNING_RATE = 5e-6
    WEIGHT_DECAY = 0.01
    NUM_EPOCHS = 10
    WARMUP_RATIO = 0.15
    ...
    # Counterfactual augmentation (from Exp17)
    CF_RATIO = 0.3
...
# ============================================================================
# 5. LOGIC-AWARE PROMPT (FROM EXP12)
# ============================================================================
...
def create_logic_aware_prompt(syllogism_text):
    """Logic-Aware Structured Prompt from Exp12 - key for high accuracy."""
...
Answer (valid/invalid):""".format(**parsed)
...
class CombinedDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Use Logic-Aware Prompt (from Exp12)
...
def main():
    print("=" * 70)
    print("Exp 19: Exp17 + Exp12 Combined")
    print("  - Counterfactual Augmentation (from Exp17)")
    ...
    train_dataset = CombinedDataset(train_split, tokenizer, Config.MAX_LENGTH, 
                                    cf_generator=cf_generator, cf_ratio=Config.CF_RATIO)
    val_dataset = CombinedDataset(val_split, tokenizer, Config.MAX_LENGTH)
    test_dataset = CombinedDataset(test_data, tokenizer, Config.MAX_LENGTH, is_test=True)
