"""
================================================================================
SemEval-2026 Task 11 - Subtask 1: Experiment 27 - Qwen 2.5 (LoRA) + Exp21 Fixed CF
================================================================================
Description: Combines the "Math Powerhouse" model (Qwen 2.5) with our 
             best-performing data augmentation method (Exp21 Fixed CF).
             
             Hypothesis: The strong reasoning backbone of Qwen combined with 
             the debiasing signal from Valid->Invalid counterfactuals should 
             yield the ultimate SOTA performance.
             
Model: Qwen/Qwen2.5-7B-Instruct
Method: QLoRA (4-bit) + Fixed Counterfactual Augmentation (Ratio 0.5)
...
class Config:
    ...
    OUTPUT_DIR = '/kaggle/working/qwen_exp27_augmented'
...
# ============================================================================
# 4. COUNTERFACTUAL GENERATOR (From Exp21)
# ============================================================================
class CounterfactualGenerator:
    """
    Generate counterfactual syllogisms by swapping conclusions.
    FIXED: Only generates Valid -> Invalid pairs.
    """
...
def main():
    print("=" * 70)
    print(f"Exp 27: {Config.MODEL_NAME} (QLoRA) + Exp21 Augmentation")
    print("=" * 70)
