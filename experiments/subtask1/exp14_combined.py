"""
================================================================================
SemEval-2026 Task 11 - Subtask 1: Experiment 14 - Exp9 + Exp12 Combined
================================================================================
Description: Combine the best techniques:
             - From Exp9: R-Drop + Label Smoothing + Cosine LR (best TCE)
             - From Exp12: Logic-Aware Structured Prompt (highest accuracy)
             
Goal: High accuracy (like Exp12) + Low TCE (like Exp9)
...
class Config:
    ...
    OUTPUT_DIR = '/kaggle/working/deberta_exp14'
    PREDICTION_PATH = '/kaggle/working/predictions.json'
    SUBMISSION_ZIP_PATH = '/kaggle/working/predictions.zip'
    
    MODEL_NAME = 'microsoft/deberta-v3-large'
    MAX_LENGTH = 384  # Longer for structured prompt (from Exp12)
    
    # From Exp9 (best combined score)
    BATCH_SIZE = 12  # Smaller due to longer sequences
    LEARNING_RATE = 5e-6
    WEIGHT_DECAY = 0.01
    NUM_EPOCHS = 10
    WARMUP_RATIO = 0.15
...
def create_logic_aware_prompt(syllogism_text):
    """Create structured, logic-aware prompt (from Exp12)."""
...
# ============================================================================
# 5. DATASET WITH LOGIC-AWARE PROMPT
# ============================================================================
...
def main():
    print("=" * 70)
    print("Exp 14: Exp9 + Exp12 Combined")
    print("  - R-Drop + Label Smoothing + Cosine LR (from Exp9)")
    print("  - Logic-Aware Structured Prompt (from Exp12)")
    print("=" * 70)
