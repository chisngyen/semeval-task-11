"""
================================================================================
SemEval-2026 Task 11 - Subtask 1: Experiment 28 - Qwen 2.5 14B + Augmentation
================================================================================
Description: THE ULTIMATE MODEL.
             Combines the SOTA 14B Model (Exp26, Score 45.74) with the SOTA 
             Augmentation Method (Exp21/27).
             
             Hypothesis: 
             - Exp26 (14B) naturally has low TCE (2.12).
             - Exp27 (7B + Aug) reduced TCE from 5.3 -> 3.19.
             - Exp28 (14B + Aug) should drive TCE < 1.0 and Score > 50.
             
Model: Qwen/Qwen2.5-14B-Instruct
Method: QLoRA (4-bit) + Fixed Counterfactual Augmentation (Ratio 0.5)
             
Difficulty: Extreme (Memory Intensive but safe for H100)
...
class Config:
    ...
    OUTPUT_DIR = '/kaggle/working/qwen14b_exp28_aug'
...
# ============================================================================
# 4. COUNTERFACTUAL GENERATOR (From Exp21/27)
# ============================================================================
...
def main():
    print("=" * 70)
    print(f"Exp 28: {Config.MODEL_NAME} (14B) + Exp21 Augmentation")
    print("=" * 70)
